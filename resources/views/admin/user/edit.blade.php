                ...
                <div class="col-lg-8 col-md-8 col-12 bg-white">
                    ...
                    <div class="card m-5">
                        <div class="card-header bg-success">
                            <h3>Please Edit User Information</h3>
                        </div>

                        <div class="card-body">
                            <form method="POST" action="{{Route('user.update',$user->id)}}" class="pt-2">
                                @csrf
                                ...
                                <select class="form-control" id="exampleFormControlSelect1" name="role">
                                    <option value="#" class="bg-dark" selected="{{$user->role}}">Please Select One Role</option>
